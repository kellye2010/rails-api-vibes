...
`cURL` command scripts for all actions are stored in [`scripts`](scripts) with names that correspond to the API actions. Scripts are included in [`scripts`](scripts) to test actions.
